...
The top validation layer for `@kassandra-market/sdk`: it drives the whole
...
```sh
# whole e2e suite
KASSANDRA_MARKET_E2E=1 pnpm --filter @kassandra-market/sdk test:e2e

# individual files
KASSANDRA_MARKET_E2E=1 pnpm --filter @kassandra-market/sdk exec vitest run test/surfpool/smoke.test.ts
KASSANDRA_MARKET_E2E=1 pnpm --filter @kassandra-market/sdk exec vitest run test/surfpool/lifecycle-e2e.test.ts
```
