 ...
 *
 * This is the market-flavoured sibling of `../../../../kassandra/sdks/oracles/ts/test/surfpool/harness.ts`.
 * Responsibilities:
...
// helpers below, and by the surfpool lifecycle e2e via this module).
export { mintBytes, oracleBytes, tokenAccountAmount, tokenAccountBytes };
 ...
 */
const METADAO_FIXTURES: ReadonlyArray<{ id: string; file: string }> = [
...
const FAB_LAMPORTS = 1_000_000_000;
