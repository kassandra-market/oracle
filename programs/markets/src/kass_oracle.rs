...
//! `kassandra-oracles-program` crate (a cross-repo `path` dependency), we hardcode the
...
//!   - program id  ← `kassandra/programs/oracles/src/lib.rs`
//!   - tag / phase / offsets ← `kassandra/programs/oracles/src/state.rs`
...
/// From `kassandra/programs/oracles/src/lib.rs`.
